...
class VkTraceFileOutputGenerator(OutputGenerator):
    ...
    def GenerateTraceVkSource(self):
        ...
        trace_vk_src += '#endif\n'
        trace_vk_src += '\n'
        trace_vk_src += 'extern VKTRACE_CRITICAL_SECTION g_bufferToDeviceMemoryLock;\n'
        ...
        trace_vk_src += '    vktrace_create_critical_section(&g_bufferToDeviceMemoryLock);\n'
        ...
        for proto in self.cmdMembers:
            ...
            if proto.name in manually_written_hooked_funcs:
                ...
                if proto.name == 'vkGetImageMemoryRequirements':
                    trace_vk_src += 'uint32_t percentage;\n'
                    trace_vk_src += 'if (trim::getImageMemorySizeDifferenceRatio(percentage))\n'
                    trace_vk_src += '{\n'
                    trace_vk_src += '    //increase the size by percentage%\n'
                    trace_vk_src += '    pMemoryRequirements->size += pMemoryRequirements->size * percentage / 100;\n'
                    trace_vk_src += '    if (pMemoryRequirements->alignment != 0) {\n'
                    trace_vk_src += '        if ((pMemoryRequirements->size % pMemoryRequirements->alignment) != 0) {\n'
                    trace_vk_src += '            pMemoryRequirements->size = pMemoryRequirements->size - (pMemoryRequirements->size % pMemoryRequirements->alignment) +\n'
                    trace_vk_src += '                                        pMemoryRequirements->alignment;\n'
                    trace_vk_src += '        }\n'
                    trace_vk_src += '    }\n'
                    trace_vk_src += '}\n'
                if proto.name == 'vkGetImageMemoryRequirements2KHR':
                    trace_vk_src += 'uint32_t percentage;\n'
                    trace_vk_src += 'if (trim::getImageMemorySizeDifferenceRatio(percentage))\n'
                    trace_vk_src += '{\n'
                    trace_vk_src += '    //increase the size by percentage%\n'
                    trace_vk_src += '    pMemoryRequirements->memoryRequirements.size += pMemoryRequirements->memoryRequirements.size * percentage / 100;\n'
                    trace_vk_src += '    if (pMemoryRequirements->memoryRequirements.alignment != 0) {\n'
                    trace_vk_src += '        if ((pMemoryRequirements->memoryRequirements.size % pMemoryRequirements->memoryRequirements.alignment) != 0) {\n'
                    trace_vk_src += '            pMemoryRequirements->memoryRequirements.size =\n'
                    trace_vk_src += '                pMemoryRequirements->memoryRequirements.size -\n'
                    trace_vk_src += '                (pMemoryRequirements->memoryRequirements.size % pMemoryRequirements->memoryRequirements.alignment) +\n'
                    trace_vk_src += '                pMemoryRequirements->memoryRequirements.alignment;\n'
                    trace_vk_src += '        }\n'
                    trace_vk_src += '    }\n'
                    trace_vk_src += '}\n'
                if proto.name == 'vkGetImageMemoryRequirements2':
                    trace_vk_src += 'uint32_t percentage;\n'
                    trace_vk_src += 'if (trim::getImageMemorySizeDifferenceRatio(percentage))\n'
                    trace_vk_src += '{\n'
                    trace_vk_src += '    //increase the size by percentage%\n'
