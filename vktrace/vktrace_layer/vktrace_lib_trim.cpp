...
bool removeInvalidDescriptorsBeforeUpdateDescriptorSet(const VkWriteDescriptorSet *pDescriptorWrites) {
...
// valid one.
void removeInvalidDescriptorsBeforeUpdateDescriptorSets(uint32_t descriptorWriteCount,
                                                        const VkWriteDescriptorSet *pDescriptorWrites) {
    for (int i = 0; i < descriptorWriteCount; i++) {
        if (!removeInvalidDescriptorsBeforeUpdateDescriptorSet(&pDescriptorWrites[i])) {
            assert(false);
        }
    }
}
